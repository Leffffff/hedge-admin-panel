...
import MintingBurningChart2 from '../../../../public/minting-burning-chart-2.svg';
...
const Minting = () => {
  const [ethereum1, setEthereum1] = useState('1,280.00');
  const [ethereum2, setEthereum2] = useState('5,330.12');

  const [binance1, setBinance1] = useState('');
  const [binance2, setBinance2] = useState('');
    ...
    <div className='px-6 py-[47px]'>
      ...
      <div className='flex gap-6'>
        ...
        <div className='h-[428px] w-[792px] rounded-lg bg-white px-[30px] py-4'>
          ...
          <div className='flex items-center gap-6'>
            <MintingBurningChart2 />
            <div>
              <div className='flex items-center gap-[6.5px]'>
                <div className='h-[11px] w-[11px] rounded-[2px] bg-[#A7A7A7]' />
      ...
      <h4 className='mb-6 mt-12 text-[28px] font-semibold text-[#1F1E1C]'>
        Authorize un-authorized tokens
      </h4>
      <div className='flex gap-6'>
        {/*Card*/}
        <div className='h-[428px] min-w-[384px] rounded-xl bg-white p-4'>
          ...
          <div className=' mt-[32px] px-3'>
            ...
            <p className='mb-[52px] text-[22px] text-[#031734]'>35,000.000</p>
            <div className='mb-6'>
              <h4 className='mb-3 text-[18px] text-[#021229]'>
                Authorize un-authorized token
              </h4>
              <input
                value={ethereum1}
                onChange={(e) => setEthereum1(e.target.value)}
                className='h-[36px] w-[238px] rounded bg-[#F7F5F0] px-3 py-[6px]'
              />
            </div>
            <div>
              ...
              <div className='flex justify-between'>
                <div className='relative h-[36px] w-[238px]'>
                  <input
                    value={ethereum2}
                    onChange={(e) => setEthereum2(e.target.value)}
                    className='h-[36px] w-[238px] rounded bg-[#F7F5F0] px-3 py-[6px]'
                  />
                  <span className='absolute right-[12px] top-1/2 -translate-y-1/2 text-[16px] text-[#BAB8B3]'>
                    $
                  </span>
                </div>
                <button
                  className={`h-[36px] w-[84px] rounded bg-[#3885E8] text-[14px] text-white ${(!ethereum1 || !ethereum2) && 'bg-gray-300'}`}
                >
                  Authorize
                </button>
              </div>
        ...
        <div className='h-[428px] min-w-[384px] rounded-xl bg-white p-4'>
          ...
          <div className='mt-[32px] px-3'>
            ...
            <div className='mb-6'>
              ...
              <input
                value={binance1}
                onChange={(e) => setBinance1(e.target.value)}
                className='h-[36px] w-[238px] rounded bg-[#F7F5F0] px-3 py-[6px]'
              />
            </div>
            <div>
              ...
              <div className='flex justify-between'>
                <div className='relative h-[36px] w-[238px]'>
                  <input
                    value={binance2}
                    onChange={(e) => setBinance2(e.target.value)}
                    className='h-[36px] w-[238px] rounded bg-[#F7F5F0] px-3 py-[6px]'
                  />
                  <span className='absolute right-[12px] top-1/2 -translate-y-1/2 text-[16px] text-[#BAB8B3]'>
                    $
                ...
                <button
                  className={`h-[36px] w-[84px] rounded bg-[#3885E8] text-[14px] text-white ${(!binance1 || !binance2) && 'bg-gray-300'}`}
                >
                  Authorize
                </button>
              </div>
          ...
          {/*    Authorize un-authorized token*/}
          {/*  </h4>*/}
          {/*  <input className='h-[36px] w-[238px] rounded bg-[#F7F5F0] px-3 py-[6px]' />*/}
          {/*</div>*/}
          {/*<div>*/}
          {/*  <h4 className='mb-3 text-[18px] text-[#021229]'>New bank value</h4>*/}
          {/*  <div className='flex justify-between'>*/}
          {/*    <div className='relative h-[36px] w-[238px]'>*/}
          {/*      <input className='h-[36px] w-[238px] rounded bg-[#F7F5F0] px-3 py-[6px]' />*/}
          {/*      <span className='absolute right-[12px] top-1/2 -translate-y-1/2 text-[16px] text-[#BAB8B3]'>*/}
